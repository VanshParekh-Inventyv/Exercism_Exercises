 ...
 */
export function getListOfWagons(...list) {
  const [...ids] = [...list];
  return ids;
}
...
export function fixListOfWagons(ids) {
  const [firstId, secondId, ...restIds] = ids;
  const newWagons = [...restIds, firstId, secondId];
  return newWagons;
}
...
export function correctListOfWagons(ids, missingWagons) {
  const [locomotive] = ids;
  const [ , ...presentIds] = ids;
  const missingIds = [...missingWagons];
  return [locomotive, ...missingIds, ...presentIds];
}
...
export function extendRouteInformation(information, additional) {
  const completeInfo = {...information, ...additional};
  return completeInfo;
}
...
export function separateTimeOfArrival(information) {
  const {timeOfArrival: arrivalTime, ...additionalInformation} = information;
  return [arrivalTime, additionalInformation];
}
